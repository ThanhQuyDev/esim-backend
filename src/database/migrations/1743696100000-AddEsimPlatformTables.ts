...
export class AddEsimPlatformTables1743696100000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "destination" DROP COLUMN "continent"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "IDX_destination_region_destinationId"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "destination" ADD "continent" character varying NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
      `ALTER TABLE "destination" ADD "region" character varying`,
    );
    await queryRunner.query(
